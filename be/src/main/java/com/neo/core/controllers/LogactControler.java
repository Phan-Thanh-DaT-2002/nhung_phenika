...
public class LogactControler extends BaseController {
    ...
    public ResponseModel doSearch(
        ...
        try {
            ...
            pageResult = service.doSearch(Strings.emptyToNull(deviceCode),
    ...
    public ResponseModel doCreate(@RequestBody List<logaction> DTOs) {
        return service.createMultiple(DTOs);
    }
